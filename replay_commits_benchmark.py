...
def push_commits_one_by_one(args, repo, commits):
    ...
    for commit in commits:
      ...
      repo.remotes.origin.set_url(f'https://{quote(token)}:x-oauth-basic@github.com/efficientengineering/node')
...
def delete_branches(repo, branches):
    ...
    new_url = f'https://{quote(token)}:x-oauth-basic@github.com/efficientengineering/node'
